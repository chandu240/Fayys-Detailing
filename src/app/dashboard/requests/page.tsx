        ...
        {hasCard ? (
          ...
          <div className="space-y-3">
            <div className="flex gap-2 mb-1">
              <button onClick={() => setMethod('card')} className={`btn btn-sm flex-1 ${method === 'card' ? 'btn-primary' : ''}`}>Pay by card</button>
              <button onClick={() => setMethod('cash')} className={`btn btn-sm flex-1 ${method === 'cash' ? 'btn-primary' : ''}`}>Pay at wash</button>
            </div>
            {method === 'card' && (
              <div className="space-y-3">
            ...
            {method === 'cash' && (
              <div className="space-y-3">
                <p className="text-sm text-gray-500">You will pay at the wash. Your spot is confirmed once you click below.</p>
            ...
            <div key={b.id} className="card">
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col items-end gap-2 flex-shrink-0">
                  ...
                  {b.status === 'approved' && !b.email_verified && (
                    <button onClick={() => setSelectedBooking(b)} className="btn btn-primary btn-sm">
                      Confirm and Pay
                    </button>
                  )}
                  {b.amount_cents && (
